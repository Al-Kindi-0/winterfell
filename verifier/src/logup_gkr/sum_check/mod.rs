...
use air::proof::{
    CompositionPolynomial, FinalOpeningClaim, RoundProof, SumCheckProof, SumCheckRoundClaim,
};
use alloc::vec::Vec;
    ...
    V: CompositionPolyQueryBuilder<E>,
{
    ...
    pub fn verify(
        ...
        } = verify_rounds(claim, round_proofs, coin)?;
...
/// Verifies a round of the sum-check protocol.
pub fn verify_rounds_final<E, C, H>(
    claim: E,
    round_proofs: &[RoundProof<E>],
    coin: &mut C,
) -> Result<SumCheckRoundClaim<E>, Error>
