...
use math::{inner_product, FieldElement};
...
impl<E: FieldElement> GkrData<E> {
    /// Constructs a new [`GkrRandElements`] from [`LagrangeKernelRandElements`], the openings combining
    ...
    pub fn new(
        ...
        Self {
            lagrange_kernel_eval_point: lagrange,
