...
impl OodFrame {
    ...
    /// trace states.
    ///
    /// The out-of-domain frame is stored as one vector of the concatenation of values of two
    /// vectors, one from the current row and the other from the next row. Given the input frame
    ///
    ///    +-------+-------+-------+-------+-------+-------+-------+-------+
    ///    |   a1  |   a2  |  ...  |  an   |  c1   |  c2   |  ...  |  cm   |
    ///    +-------+-------+-------+-------+-------+-------+-------+-------+
        ...
        H: ElementHasher<BaseField = E::BaseField>,
    {
        ...
        // save the evaluations with the current and next evaluations for each polynomial
