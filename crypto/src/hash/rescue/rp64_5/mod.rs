...
/// Implementation of [Hasher] trait for Rescue Prime hash function with 256-bit output with permutation (F) (F) (FB') (FB') (FB') (F) (F).
///
...
impl Rp64_256 {
    ...
    pub fn apply_permutation(state: &mut [BaseElement; STATE_WIDTH]) {
        ...
        Self::apply_rp_full_round_modified(state, 2);
        Self::apply_rp_full_round_modified(state, 3);
        Self::apply_rp_full_round_modified(state, 4);
    ...
    /// (FB') round function.
    #[inline(always)]
    fn apply_rp_full_round_modified(state: &mut [BaseElement; STATE_WIDTH], round: usize) {
        // apply first half of Rescue round
        Self::apply_sbox(state);
        Self::apply_mds(state);
        Self::add_constants(state, &ARK1[round]);

        // apply second half of Rescue round without multiplication with the MDS matrix
    ...
    pub fn apply_permutation_freq(state: &mut [BaseElement; STATE_WIDTH]) {
        ...
        Self::apply_rp_half_round_freq(state, 1);
        Self::apply_rp_full_round_modified_freq(state, 2);
        Self::apply_rp_full_round_modified_freq(state, 3);
        Self::apply_rp_full_round_modified_freq(state, 4);
    ...
    /// (FB') round function.
    #[inline(always)]
    fn apply_rp_full_round_modified_freq(state: &mut [BaseElement; STATE_WIDTH], round: usize) {
        // apply first half of Rescue round
        Self::apply_sbox(state);
