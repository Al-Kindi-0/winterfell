...
/// The following implementation has benefited greatly from ideas and discussions with the Polygon
/// Zero team.
...
// MDS matrices efficiently in original domain, that was kindly provided by the Polygon Zero team.
...
pub(crate) fn mds_multiply_freq(state: [u64; 12]) -> [u64; 12] {
    ...
    // This where the multiplication in frequency domains is done. More precisely, and with
    ...
    // The expressions in the aformentioned functions are the result of explicit computations in
    // combination with the Karatsuba trick for the multiplication of Complex numbers.
